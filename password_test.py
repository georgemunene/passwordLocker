...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        self.new_user = User("george", "12056")

    def tearDown(self):
        User.user_list = []

    def test_init(self):
        self.assertEqual(self.new_user.name, "george")
    ...
    def test_save_multiple_user(self):
        ...
        test_user = User("ken", "12345")  # new user
        test_user.save_user()
...
class TestCredential(unittest.TestCase):
    ...
    def setUp(self):
        self.new_credential = Credential("facebook", "keng", "12345")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_credential.account_username, "keng")
    ...
    def test_save_multiple_credential(self):
        ...
        test_credential = Credential("Twitter", "ken", "123456")  # new credential
    ...
    def test_delete_credential(self):
        ...
        """
        self.new_credential.save_credential()
        test_credential = Credential("facebook", "keng", "12345")
        test_credential.save_credential()
    ...
    def test_find_credential_by_account_username(self):
        ...
        test_credential = Credential("facebook", "keng", "12345")
        test_credential.save_credential()
        found_credential =Credential.find_by_account_username("keng")
    ...
    def test_credential_exists(self):
        ...
        test_credential = Credential("facebook", "keng", "12345")
        test_credential.save_credential()
        credential_exists = Credential.credential_exists("keng")
